...
from keras.preprocessing.image import ImageDataGenerator  #导入各种用到的模块组件
...
model.add(Conv2D(4, 1, 5, 5, border_mode='valid'))
model.add(Activation('tanh'))

#第二个卷积层，8个卷积核，每个卷积核大小3*3。4表示输入的特征图个数，等于上一层的卷积核个数
#激活函数用tanh
#采用maxpooling，poolsize为(2,2)
model.add(Conv2D(8,4, 3, 3, border_mode='valid'))
model.add(Activation('tanh'))
